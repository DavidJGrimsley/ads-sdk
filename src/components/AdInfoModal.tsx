 ...
 */
export default function AdInfoModal({ visible, onClose }: AdInfoModalProps) {
  return (
    <Modal
      visible={visible}
      transparent
          ...
          <ScrollView className="max-h-96">
            <View className="p-5">
              <Text className="text-gray-700 dark:text-gray-300 text-sm mb-4 leading-5">
                These cards highlight services offered directly by David J Grimsley, the creator of this app.
              ...
              <View className="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-3 mb-4">
                <View className="flex-row items-start mb-2">
                  ...
                  <View className="flex-1">
                    ...
                    <Text className="text-gray-600 dark:text-gray-400 text-xs leading-4">
                      Using these services helps support the continued development of this app
                    </Text>
                  </View>
                </View>
              </View>
              ...
              <Text className="text-gray-600 dark:text-gray-400 text-xs leading-5 italic mb-4">
